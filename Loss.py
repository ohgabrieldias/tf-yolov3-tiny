...
def yolo_tiny_loss(y_true, y_pred, S):
    """
    Versão corrigida para formato (batch_size, 26, 26, 18)
    Onde 18 = B*(5+NUM_CLASSES) com B=3 anchors e NUM_CLASSES=1 classe
    """
    ...
    # Redimensiona para (batch_size, S, S, B, 5 + NUM_CLASSES)
    ...
    pred_class = pred[..., 5:]   # class probs (shape [batch_size, S, S, B, NUM_CLASSES])
    ...
    no_obj_loss = LAMBDA_NO_OBJECT * tf.reduce_sum(
    ...
    box_loss = LAMBDA_CLASS * tf.reduce_sum(
